...
def creat_instance():
    ...
    hotel2  = Hotel("Bangkok","Oakwood")
    hotel3  = Hotel("Bangkok","Baiyoke Sky")
    hotel4  = Hotel("Bangkok","The Quartier")
    ...
    hotel9  = Hotel("Chonburi","Bangsean")
    hotel10 = Hotel("Chonburi","Karin")
    hotel11 = Hotel("Chonburi","Citadines Grand Central")
    hotel12 = Hotel("Chonburi","Madera Residence")
    hotel13 = Hotel("Phuket","The Blanket")
    hotel14 = Hotel("Phuket","Blue Carina")
    hotel15 = Hotel("Phuket","Blu Monkey")
    hotel16 = Hotel("Phuket","Seabed Grand")
    hotel17 = Hotel("Khon kaen","Nadee 10")
    hotel18 = Hotel("Khon kaen","Romantic")
    hotel19 = Hotel("Khon kaen","Sirin")
    hotel20 = Hotel("Khon kaen","Le cassia")
    hotel21 = Hotel("Rayong","Star Convention")
