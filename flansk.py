...
BANGSEAN_HOTEL = 'room_amorathapae'
BLU_MONKEY_HOTEL = 'room_amorathapae'
BLUE_CARINA_HOTEL = 'room_amorathapae'
CENTARA_CHIANG_MAI = 'room_amorathapae'
CITADINES_GRAND_CENTRAL = 'room_amorathapae'
GLORY_BOUTIQUE_HOTEL = 'room_amorathapae'
HOTEL_FUSE_RAYONG = 'room_amorathapae'
KARIN_HOTEL = 'room_amorathapae'
LE_CASSIA_HOTEL = 'room_amorathapae'
LIT_BANGKOK = 'room_amorathapae'
MADERA_RESIDENCE = 'room_amorathapae'
NADEE_10_HOTEL = 'room_amorathapae'
NOVOTEL_RAYONG_STAR_CENTRE = 'room_amorathapae'
OAKWOOD_HOTEL = 'room_amorathapae'
PHAVINA_HOTEL_RAYONG = 'room_amorathapae'
ROMANTIC_HOTEL = 'room_amorathapae'
SEABED_GRAND_HOTEL = 'room_amorathapae'
SIRIN_HOTEL = 'room_amorathapae'
STAR_CONVENTION_HOTEL = 'room_amorathapae'
THE_BLANKET_HOTEL = 'room_amorathapae'
